...
// or
docker exec -it shard-01-product-node-a bash -c "echo 'rs.addArb(\""shard01-x:27017\"")' | mongosh --port 27017"
```
...
// or
docker exec -it shard-02-product-node-a bash -c "echo 'rs.addArb(\""shard02-x:27017\"")' | mongosh --port 27017"
```
...
// or
docker exec -it shard-03-product-node-a bash -c "echo 'rs.addArb(\""shard03-x:27017\"")' | mongosh --port 27017"
```
...
```
  ...
  shards:
        {  "_id" : "rs-shard-01-product",  "host" : "rs-shard-01-product/shard01-a:27017,shard01-b:27017",  "state" : 1 }
        {  "_id" : "rs-shard-02-product",  "host" : "rs-shard-02-product/shard02-a:27017,shard02-b:27017",  "state" : 1 }
        {  "_id" : "rs-shard-03-product",  "host" : "rs-shard-03-product/shard03-a:27017,shard03-b:27017",  "state" : 1 }
  active mongoses:
        "4.0.10" : 2
  autosplit:
...
{
        "raw" : {
                "rs-shard-01-product/shard01-a:27017,shard01-b:27017" : {
                        "db" : "MyDatabase",
                        "collections" : 1,
                        "views" : 0,
                        "objects" : 0,
                ...
                "rs-shard-03-product/shard03-a:27017,shard03-b:27017" : {
                        "db" : "MyDatabase",
                        "collections" : 1,
                        "views" : 0,
                        "objects" : 0,
                ...
                "rs-shard-02-product/shard02-a:27017,shard02-b:27017" : {
                        "db" : "MyDatabase",
                        "collections" : 1,
                        "views" : 0,
                        "objects" : 0,
