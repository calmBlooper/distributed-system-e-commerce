...
// or
docker exec -it shard-01-receipt-node-a bash -c "echo 'rs.addArb(\""shard01-x:27017\"")' | mongosh --port 27017"
```
...
// or
docker exec -it shard-02-receipt-node-a bash -c "echo 'rs.addArb(\""shard02-x:27017\"")' | mongosh --port 27017"
```
...
// or
docker exec -it shard-03-receipt-node-a bash -c "echo 'rs.addArb(\""shard03-x:27017\"")' | mongosh --port 27017"
```
...
```
  ...
  shards:
        {  "_id" : "rs-shard-01-receipt",  "host" : "rs-shard-01-receipt/shard01-a:27017,shard01-b:27017",  "state" : 1 }
        {  "_id" : "rs-shard-02-receipt",  "host" : "rs-shard-02-receipt/shard02-a:27017,shard02-b:27017",  "state" : 1 }
        {  "_id" : "rs-shard-03-receipt",  "host" : "rs-shard-03-receipt/shard03-a:27017,shard03-b:27017",  "state" : 1 }
  active mongoses:
        "4.0.10" : 2
  autosplit:
...
docker exec -it shard-03-receipt-node-a bash -c "echo 'rs.status()' | mongosh --port 27017" 
```
*Sample Result:*
```
...
{
        "raw" : {
                "rs-shard-01-receipt/shard01-a:27017,shard01-b:27017" : {
                        "db" : "MyDatabase",
                        "collections" : 1,
                        "views" : 0,
                        "objects" : 0,
                ...
                "rs-shard-03-receipt/shard03-a:27017,shard03-b:27017" : {
                        "db" : "MyDatabase",
                        "collections" : 1,
                        "views" : 0,
                        "objects" : 0,
                ...
                "rs-shard-02-receipt/shard02-a:27017,shard02-b:27017" : {
                        "db" : "MyDatabase",
                        "collections" : 1,
                        "views" : 0,
                        "objects" : 0,
