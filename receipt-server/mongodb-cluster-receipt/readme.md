...
// Enable sharding for database `receipt`
sh.enableSharding("receipt")

// Setup shardingKey for collection `receipts`**
db.adminCommand( { shardCollection: "receipt.receipts", key: {  user:"hashed"  } } )
...
```
mongodb://127.0.0.1:27217,127.0.0.1:27218
```
